package ru.alenbarkalov.uaa.web.rest;
...
import ru.alenbarkalov.uaa.JhipsterSampleApplicationUaaApp;
import ru.alenbarkalov.uaa.config.TestSecurityConfiguration;
import ru.alenbarkalov.uaa.config.audit.AuditEventConverter;
import ru.alenbarkalov.uaa.domain.PersistentAuditEvent;
import ru.alenbarkalov.uaa.repository.PersistenceAuditEventRepository;
import ru.alenbarkalov.uaa.security.AuthoritiesConstants;
import ru.alenbarkalov.uaa.service.AuditEventService;
...
@SpringBootTest(classes = { JhipsterSampleApplicationUaaApp.class, TestSecurityConfiguration.class })
@Transactional
